...
## `height` vs. `earn`
ggplot(heights_df, aes(x=height, y=earn)) + geom_point()+ geom_smooth() + labs(x="height", y="earn")
## `age` vs. `earn`
ggplot(heights_df, aes(x=age, y=earn)) + geom_point() + geom_smooth() + labs(x="age", y="earn")
## `ed` vs. `earn`
ggplot(heights_df, aes(x=ed, y=earn)) + geom_point() + geom_smooth() + labs(x="ed", y="earn")
